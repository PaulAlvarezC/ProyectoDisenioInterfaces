    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <img src=https://www.toptechegypt.com/ibm/img/TOPTECH-logo.png title="User Image" alt="User image" style="width: 230px; height: 60px" />
                    ...
                    <div class="col-sm-2">
                        <div class="card mt-3">
                            <div class="card-header text-center">
                                <label>FECHA: ${c.getFecha()}</label>
                            </div>
                            <div class="card-body text-center">                                
                                <label>ESTADO : ${c.getEstado()}</label>  
                            </div>
                            <div class="card-footer text-center">
                                <label>TOTAL: ${c.getMonto()}</label>                                                              
                            </div>
                        </div>
                    </div>
                </c:forEach>
